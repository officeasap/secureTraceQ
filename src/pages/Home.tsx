        ...
        <div className="w-full max-w-[480px]">
          <div className="securesoft-card depth-5">
            <div className="text-center mb-8">
              ...
              <p className="text-[#c8dff9] text-sm uppercase tracking-widest">
            ...
            <form onSubmit={handleVerify} className="space-y-5">
              <div>
               <label className="block text-[#c8dff9] text-xs uppercase tracking-widest mb-2">
  Tracking Code
</label>
            ...
            <div className="mt-6 pt-6 border-t border-[#2A2F35]">
              <div className="flex justify-center gap-4 text-[10px] text-secondary uppercase tracking-widest">
                <span className="text-[#c8dff9]">ISO 27001</span>
<span className="text-[#c8dff9]">|</span>
<span className="text-[#c8dff9]">SOC2 Compliant</span>
<span className="text-[#c8dff9]">|</span>
<span className="text-[#c8dff9]">Corporate Use Only</span>
